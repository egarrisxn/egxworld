    ...
    <main className='min-h-full border-2 border-green-400 pb-16 dark:border-green-300'>
      ...
      <div className='mx-auto mt-12 flex w-full max-w-5xl flex-col gap-12 px-4 sm:mt-16 sm:px-8 xl:max-w-6xl 2xl:mt-24 2xl:max-w-7xl'>
        ...
        <article className='mx-auto grid grid-cols-1 justify-center pt-4 md:mx-12 lg:mx-16 xl:mx-auto'>
          <h2 className='text-2xl font-extrabold leading-7 shadow-foreground drop-shadow-2xl md:text-3xl lg:text-4xl lg:leading-10 lg:tracking-wide xl:text-5xl 2xl:text-6xl'>
          ...
          <div className='mt-5 text-sm font-medium md:text-base lg:mt-8 lg:text-lg xl:text-xl 2xl:text-3xl'>
            <section className='space-y-5'>
              ...
              <p className='font-extrabold lg:pt-4'>
            ...
            <section className='mt-10 flex flex-col gap-5 border-t border-green-500 pt-2 shadow-foreground drop-shadow-2xl sm:flex-row sm:gap-3 sm:pt-4 md:gap-4 lg:pt-8 xl:mb-12 dark:border-green-300'>
              ...
              <div className='flex max-w-80 flex-wrap items-center gap-1.5 sm:w-3/4 md:max-w-none lg:gap-3 xl:gap-4 2xl:pr-20'>
                <TechList />
              </div>
            </section>

            <section className='mt-10 flex flex-col gap-5 border-t border-green-500 pt-2 shadow-foreground drop-shadow-2xl sm:flex-row sm:gap-3 sm:pt-4 md:gap-4 lg:pt-8 2xl:mb-12 dark:border-green-300'>
              <p className='h-fit sm:w-1/4 sm:border-r sm:border-green-500 sm:pr-1'>
                <span className='font-bold text-green-500 dark:text-green-300'>Contributions</span>{' '}
                & <span className='font-bold text-green-500 dark:text-green-300'>time</span> on
                GitHub:
              </p>
