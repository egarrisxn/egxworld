    ...
    <div className='mx-auto flex flex-col justify-center min-[400px]:mx-8 sm:mx-16 lg:mx-auto'>
      <section className='flex flex-row gap-4'>
        <aside className='lg:mt-2 2xl:mt-3.5 2xl:hidden'>
          <Image src='/other/hero-image.png' width={100} height={100} priority alt='My Photo' />
        </aside>
      ...
      <section className='grid grid-cols-1'>
        <div className='order-1 my-4 flex flex-row justify-center gap-4 text-2xl min-[350px]:justify-start md:text-3xl lg:order-2 lg:ml-[7rem] lg:text-4xl 2xl:ml-[12rem] 2xl:pl-1 2xl:text-5xl'>
          <TooltipProvider>
            <Icon
        ...
        <div className='order-2 my-4 flex flex-col gap-4 min-[350px]:flex-row lg:order-1 lg:ml-[7rem] 2xl:ml-[12rem] 2xl:gap-6'>
          <Button
            variant='outline'
            size='sm'
