  ...
  return (
    <>
      ...
      <div className='group relative ml-1.5 overflow-hidden'>
        <div className='transition-transform duration-300 group-hover:-translate-y-16 motion-reduce:transform-none'>
        ...
        <div className='absolute left-0 top-0 translate-y-16 shadow-foreground drop-shadow-md transition-transform duration-300 group-hover:translate-y-0 motion-reduce:transform-none'>
          <h3 className='flex cursor-default bg-gradient-to-tl from-zinc-300 via-zinc-500 to-zinc-700 bg-clip-text leading-tight tracking-tight text-transparent delay-75 min-[320px]:text-lg min-[385px]:text-xl min-[460px]:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl'>
