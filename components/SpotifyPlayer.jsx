      ...
      {loading ? (
        ...
        <section className='flex max-w-72 items-center gap-1 sm:max-w-96 lg:flex-col lg:gap-0.5'>
          <div className='flex flex-row items-center gap-0.5'>
            ...
            <h3 className='text-sm font-semibold tracking-tighter lg:text-base'>
            ...
            <a href={result.songUrl} target='_blank' rel='noopener noreferrer'>
              <div className='group flex items-center gap-1 lg:flex-col lg:gap-0'>
                <Image
                  ...
                  className='flex size-4 rounded-sm transition-all duration-150 ease-in-out group-hover:ring-1 group-hover:ring-green-400 lg:size-28 lg:border-2 lg:border-foreground lg:shadow-[-2px_4px_6px_0px_#01091c] lg:group-hover:ring-4'
                  width={112}
                  height={112}
                />
                <p className='max-w-36 truncate text-sm tracking-tighter transition-all duration-150 ease-in-out group-hover:font-semibold group-hover:text-green-400 sm:max-w-60 lg:max-w-28 lg:text-base'>
                  {result.artist}
                </p>
              </div>
            </a>
