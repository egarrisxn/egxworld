...
export function SpotifyPlayer() {
  ...
  return (
    <>
      {loading ? (
        <section className='flex-grow text-sm font-semibold tracking-tighter lg:text-base xl:text-lg 2xl:text-2xl'>
          Loading..
        </section>
      ) : (
        <section className='flex max-w-72 items-center gap-1 sm:max-w-96 lg:flex-col lg:gap-0.5'>
          <div className='flex flex-row items-center gap-0.5'>
            ...
            <h3 className='text-sm font-semibold tracking-tighter lg:text-base xl:text-lg 2xl:text-2xl'>
            ...
            <a href={result.songUrl} target='_blank' rel='noopener noreferrer'>
              <div className='group flex items-center gap-1 lg:flex-col lg:gap-0'>
                <Image
                  ...
                  height={128}
                />
                <p className='max-w-36 truncate text-sm tracking-tighter transition-all duration-150 ease-in-out group-hover:font-semibold group-hover:text-green-400 sm:max-w-60 lg:max-w-28 lg:text-base xl:text-lg 2xl:text-2xl'>
                  {result.artist}
                </p>
              </div>
            </a>
