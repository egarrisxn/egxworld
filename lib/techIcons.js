const TechIcons = () => {
  return (
    <>
      ...
      {/* Git */}
      <a href='https://www.git-scm.com/' target='_blank' rel='noopener noreferrer'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width='1.2em'
          height='1.2em'
      ...
      {/* HTML5 */}
      <a href='https://www.html.com/html5/' target='_blank' rel='noopener noreferrer'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width='1.2em'
          height='1.2em'
      ...
      {/* React */}
      <a href='https://reactjs.com/' target='_blank' rel='noopener noreferrer'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width='1.2em'
          height='1.2em'
