...
export async function getNowPlayingItem() {
  try {
    ...
    console.error('Error fetching now playing item:', error) // Logs any error that occurs
    return {
      isPlaying: false,
      albumImageUrl: '',
      artist: '',
...
export async function getTopTracksList() {
  try {
    ...
    console.error('Error fetching top tracks:', error) // Logs any error that occurs
